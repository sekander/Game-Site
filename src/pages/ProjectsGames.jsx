...
const ModalNav = styled.div`
  ...
  padding-bottom: 1rem;
  border-bottom: 1px solid ${({ theme }) => theme.colors.border || "rgba(255,255,255,0.08)"};
`;
...
const ModalDot = styled.span`
  ...
  background: ${({ active, theme }) => 
    active ? theme.colors.primary || "#e8d5a3" : theme.colors.border || "rgba(255,255,255,0.2)"
  };
  transition: all 0.3s ease;
  cursor: pointer;
...
const TechnicalPlaceholder = styled.div`
  ...
  border-radius: 12px;
  border: 2px dashed ${({ theme }) => theme.colors.border || "rgba(255,255,255,0.08)"};
  padding: 2rem;
  text-align: center;
...
export default function ProjectsGames() {
  ...
  const buildProjects = () => {
    ...
    // Debug: Log what we're getting from WordPress
    console.log("🔍 Projects Content:", projectsContent);
    console.log("🔍 projects_json field:", projectsContent.projects_json);
    ...
    if (projectsContent.projects_json) {
      try {
        ...
        if (Array.isArray(parsedProjects) && parsedProjects.length > 0) {
          ...
          // Debug: Check if technical field is being populated
          console.log("📋 Mapped Projects with technical:", mappedProjects.map(p => ({
            title: p.title,
            hasTechnical: !!p.technical,
            technicalPreview: p.technical ? p.technical.substring(0, 100) + "..." : "No technical data"
          })));
    ...
    console.log("⚠️ Using fallback projects with technical data");
    ...
    return [
      {
        ...
        gallery: [],
        technical: "<h3>Engine</h3><p>Built with Unity 2022.3 LTS</p><h3>Platforms</h3><ul><li>Windows PC</li><li>Android</li><li>iOS</li></ul><h3>Key Technologies</h3><ul><li>Unity Netcode for GameObjects</li><li>Input System Package</li><li>Universal Render Pipeline</li></ul>"
      },
      {
        id: 2,
        title: "Contra Remix",
        ...
        gallery: [],
        technical: "<h3>Engine</h3><p>Built with Godot 4.2</p><h3>Features</h3><ul><li>State Machine AI</li><li>Split-screen multiplayer</li><li>Dynamic difficulty scaling</li></ul>"
      },
      {
        id: 3,
        ...
        gallery: [],
        technical: "<h3>Framework</h3><p>Built with LIBGDX</p><h3>Platforms</h3><ul><li>Android (Google Play)</li><li>Desktop (Windows, Mac, Linux)</li><li>HTML5 (WebGL)</li></ul><h3>Features</h3><ul><li>Multi-threading for pattern generation</li><li>AdMob integration</li><li>High score tracking</li></ul>"
      }
    ];
  };
  ...
  const openModal = (project) => {
    ...
    console.log("📝 Technical content:", project.technical);
  ...
  const navigateLightbox = (direction) => {
    ...
    const newIndex = (currentGalleryIndex + direction + projectGallery.length) % projectGallery.length;
  ...
  const renderPageContent = (project, page) => {
    ...
    switch (page) {
      case 0: // Overview
        return (
          <ModalPage>
            ...
            {!project.showImage && (
              <ModalImage style={{ background: "linear-gradient(135deg, #2a2a4a, #1a1a2e)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            {project.link && project.link !== "#" && (
              ...
              >
                {project.link.includes("steam") ? "View on Steam →" : "Learn More →"}
              </ModalLink>
            )}
          </ModalPage>
        );
      ...
      case 1: // Gallery
        return (
          <ModalPage>
            <h3 style={{ color: "#e8d5a3", marginBottom: "1rem", fontSize: "1.2rem" }}>
              Gallery
              ...
              <GalleryGridContainer>
                {projectGallery.map((image, index) => (
                  ...
                  >
                    ...
                    >
                      <GalleryImageTitle>{image.title}</GalleryImageTitle>
          ...
          <CardGrid>
            {projects.map((project, index) => (
              ...
              >
                ...
                {!project.showImage && (
                  <CardImage style={{ background: "linear-gradient(135deg, #2a2a4a, #1a1a2e)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                ...
                <CardContent>
                  ...
                  <CardTags>
                    ...
                    {extractTags(project).slice(0, 2).map((tag, i) => (
                      <Tag key={i}>{tag}</Tag>
                    ))}
                  </CardTags>
                </CardContent>
          ...
          >
            ...
            >
              ...
              <ModalNav>
                ...
                <ModalNavButton onClick={nextPage} disabled={currentPage === totalPages - 1}>
                  Next →
                </ModalNavButton>
              </ModalNav>
        ...
        {selectedGalleryImage && (
          ...
          >
            ...
            >
              ...
              <LightboxImage src={selectedGalleryImage.src} alt={selectedGalleryImage.title} />
              <LightboxInfo>
                <h3>{selectedGalleryImage.title}</h3>
                <p>{selectedGalleryImage.description}</p>
              </LightboxInfo>
              <LightboxNav>
                <LightboxNavButton onClick={() => navigateLightbox(-1)}>‹</LightboxNavButton>
                <LightboxNavButton onClick={() => navigateLightbox(1)}>›</LightboxNavButton>
              </LightboxNav>
            </LightboxContent>
          </LightboxOverlay>
